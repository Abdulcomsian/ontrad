    ...
    <form class="form-inline" action="/action_page.php">
        <div class="row pt-0">
            <div class="col-sm-12 col-md-10 col-lg-9 " style="text-align: right;">
                <input class="form-control ml-sm-2" id="search_query" type="text" placeholder="Find a Theme to Edit">
            </div>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
      echo "<tr><td>". $row["theme_title"] ."</td>"."
            <td><a href=editTheme.php?id=". $row["id"] ." class='btn btn-primary btn-sm'>Edit</a></td></tr>";
      }
          echo "</table>";
      } else {
